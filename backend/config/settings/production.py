...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_RATES': {
        ...
        'reservation': '20/hour',   # 20 reservation creations per hour per user
        'review': '5/day',          # 5 review submissions per day per user
    },
}

SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=30),   # tighter in production
