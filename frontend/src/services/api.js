...
const BASE_URL = process.env.REACT_APP_API_URL || 'https://wayyout-backend.onrender.com/api';
...
// Attach access token; let FormData requests set their own Content-Type
